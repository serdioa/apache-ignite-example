...
/**
 * Listens on {@code User} objects based on the "thin client" Ignite API.
 */
@Slf4j
public class UserConsumerIgniteClient {
    ...
    private void createContinuousQuery() {
        ...
        this.userContinuousQueryCursor = this.userCache.query(this.userContinousQuery,
                this::onContinuousQueryDisconnected);
    }
    ...
    private void onContinuousQueryDisconnected(final Exception reason) {
        log.info("Continuous query disconnected", reason);
    }
}
