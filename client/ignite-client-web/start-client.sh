...
SPRING_OPTIONS="--spring.config.location=src/main/config/ignite-client-web.properties --logging.config=src/main/config/logback-client-web.xml"

# mvn package spring-boot:repackage

EXEC_JAR=$(/bin/find target -name ignite-client-web-*.jar)
